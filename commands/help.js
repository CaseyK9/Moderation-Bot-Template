...
module.exports.run = async (client, message, args) => {
  ...
  if (command) {
        ...
        let newembed = new Discord.RichEmbed()
          ...
          .setFooter(`Bot created by @Muednei🦊#0001 • ${commandnum} Commands`, "https://cdn.discordapp.com/avatars/282544478454022145/769bbc3c93eed5782b61e5e6edd1b9bd.png?size=2048")
    ...
    if (done) {
      if (!command) {
        var embed = new Discord.RichEmbed()
          ...
          .setColor("3498db")
          .setImage(client.AvatarURL)
          .setFooter(`Bot created by @bluesn0w#9915 • ${commandnum} Commands`, "https://cdn.discordapp.com/avatars/282544478454022145/769bbc3c93eed5782b61e5e6edd1b9bd.png?size=2048")               
